/**
 * blog-posts-data.js — Shared Medium posts for home + blog pages.
 */
(function () {
  'use strict';
  window.BLOG_POSTS = [
    ...
    },
    {
      ...
      description:
        "There's a quiet truth most product teams learn over time: code scales, design differentiates.",
    ...
    },
    {
      ...
      description:
        'A side project to fix my own "where did we do this before?" problem, built with Cursor, and how it could scale for the full design team.',
